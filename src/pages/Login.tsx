...
const Login = (props: { disableCustomTheme?: boolean }) => {
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        apiLogin(data.get("username") as string, data.get("password") as string).then((data) => {
            console.log(data);
            if (data.status === "ok") {
            ...
            <SignInContainer direction="column" justifyContent="space-between">
                ...
                <Card variant="outlined">
                    ...
                    >
                        ...
                        <FormControlLabel control={<Checkbox color="primary" onChange={handleCheckboxChange} />} label="Show password" />
