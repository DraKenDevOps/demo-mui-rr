...
import type { DialogComponent, OpenDialog, OpenDialogOptions } from "./useDialog";
...
export default function DialogProvider(props: DialogProviderProps) {
    ...
    const requestDialog = useEventCallback<OpenDialog>(function open<P, R>(Component: DialogComponent<P, R>, payload: P, options: OpenDialogOptions<R> = {}) {
